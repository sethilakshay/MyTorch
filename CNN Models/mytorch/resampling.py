...
class Upsample1d():
    ...
    def forward(self, A):
        ...
        Z = np.zeros(shape = (A.shape[0], A.shape[1], output_width))
...
class Upsample2d():
    ...
    def forward(self, A):
        ...
        Z = np.zeros(shape = (A.shape[0], A.shape[1], output_height, output_width))
...
class Downsample2d():
    ...
    def backward(self, dLdZ):
        ...
        Return:
            dLdA (np.array): (batch_size, in_channels, input_height, input_width)
        """
        dLdA = np.zeros(shape = (dLdZ.shape[0], dLdZ.shape[1], self.input_height, self.input_width))
